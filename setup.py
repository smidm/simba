...
setuptools.setup(
    ...
    install_requires=['Pillow == 5.4.1', 'pyyaml == 5.3.1','shapely == 1.7',
              'dtreeviz == 0.8.1','eli5==0.11.0', 'graphviz == 0.11','deepposekit == 0.3.5',
              'imbalanced-learn==0.8.0','imgaug == 0.4.0','imutils == 0.5.2','matplotlib == 3.0.3', 'numpy == 1.18.1',
              'opencv-python == 3.4.5.20','pandas == 0.25.3','scikit-image == 0.14.2', 'scipy == 1.1.0','seaborn == 0.9.0',
              'scikit-learn == 0.24','tabulate == 0.8.3','tqdm == 4.30.0','xgboost == 0.90',
              'yellowbrick == 1.3', 'dash == 1.14.0', 'dash_color_picker == 0.0.1', 'dash_core_components == 1.10.2', 
